...
# ===================================================================
# SeedVDataset  (multi-channel, 5-class emotion classification)
# ===================================================================

class SeedVDataset(_BaseSeedDataset):
    """Dataset for SEED-V emotion recognition.

    Each sample yields an EEG window plus a 5-class label
    (0 = disgust, 1 = fear, 2 = sad, 3 = neutral, 4 = happy).

    The preprocessed directory layout and file format are identical to
    SEED, so the scanning / caching / windowing logic from

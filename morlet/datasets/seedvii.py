...
# ===================================================================
# SeedVIIDataset  (multi-channel, 7-class emotion classification)
# ===================================================================

class SeedVIIDataset(_BaseSeedDataset):
    """Dataset for SEED-VII emotion recognition.

    Each sample yields an EEG window plus a 7-class label
    (0 = disgust, 1 = fear, 2 = sad, 3 = neutral, 4 = happy,
     5 = anger, 6 = surprise).

    The preprocessed directory layout and file format are identical to
    SEED / SEED-V, so the scanning / caching / windowing logic from
    :class:`_BaseSeedDataset` is fully reused.
    """
